...
$hideSearch = true; // Ocultar búsqueda en home, tendremos un buscador especial
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
        <?php if (!empty($categorias)): ?>
            <?php foreach ($categorias as $categoria): ?>
                <a href="<?= BASE_URL ?>/index.php?module=public&action=catalogo&categoria=<?= urlencode($categoria['nombre']) ?>" 
